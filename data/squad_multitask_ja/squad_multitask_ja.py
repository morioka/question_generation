...
class SquadMultitaskConfigJa(nlp.BuilderConfig):
    ...
    """
        super(SquadMultitaskConfigJa, self).__init__(**kwargs)
        self.qg_format = qg_format


class SquadMultitaskJa(nlp.GeneratorBasedBuilder):
    """JSQUAD: a Japanese version of SQuAD. Version 1.0."""

    _URL = "https://github.com/yahoojapan/JGLUE/raw/main/datasets/jsquad-v1.0/"
    _DEV_FILE = "valid-v1.0.json"
    _TRAINING_FILE = "train-v1.0.json"

    BUILDER_CONFIGS = [
        SquadMultitaskConfigJa(
